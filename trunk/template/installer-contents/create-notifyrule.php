...
if((isset($_SESSION['user_data']) && $_SESSION['user_data']['ruolo']!=3) && (isset($_SESSION['user_data']) && $_SESSION['user_data']['ruolo']!=2)) {
                        ...
                        <form class="col s12" method="POST" action="<?php echo $_SERVER['PHP_SELF']."?id=".$_GET['id']; ?>">
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="submit">Configura notifica

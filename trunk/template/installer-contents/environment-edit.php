...
$ambiente = $environmentManager->trovaAmbiente($_GET['id']);

// quando ricevo un POST sulla pagina
if(isset($_POST['submit'])){
  $post = filter_input_array(INPUT_POST, FILTER_SANITIZE_STRING);
  $checkValue = $environmentManager->modificaAmbiente($post,$_GET['id']);
            ...
            <div class="col s12 m12 l12">
              ...
              <ol class="breadcrumbs">
                  ...
                  <li><a href="<?php echo ROOT_URL.TEMPLATE_PATH?>installer-contents/system-details.php?id=<?php 
                   echo $_GET['id']?>">Dettagli impianto</a></li>
                  <li><a href="<?php echo ROOT_URL.TEMPLATE_PATH?>installer-contents/environment-details.php?id=<?php echo $ambiente['IDAmbiente']?>">Dettagli ambiente</a></li>
                        ...
                        <form class="col s12" method="POST" action="<?php echo $_SERVER['PHP_SELF']."?id=".$_GET['id']; ?>">
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              ...
                              value="<?php echo $ambiente['ambNome']; ?>" >
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              ...
                              value="<?php echo $ambiente['Descrizione'];  ?>" >
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                             ...
                             <a href="environment-details.php?id=<?php echo $_GET['id']; ?>" class="btn waves-effect pink white-text admin-create-user">Annulla</a>

                              <button class="btn cyan waves-effect waves-light right" type="submit" name="submit">Modifica ambiente

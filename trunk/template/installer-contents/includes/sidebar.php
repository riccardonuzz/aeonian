        ...
        <li id="bg-user" class="user-details cyan darken-2">
            <div class="row">
                <div class="col col s8 m8 l12">                        
                    <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown"><?php echo $_SESSION['user_data']['nome']." " ?></a>

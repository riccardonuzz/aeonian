                    ...
                    <div class="col s12 m8 l12">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <i onclick="elimina('<?php echo ROOT_URL.TEMPLATE_PATH.'user-contents/notify-management.php';?>', '<?php echo $rule['IDRegola']; ?>')"  class="custom-icon btn-warning-confirm mdi-action-delete"></i>
                                </td>                            
                            </tr>                                
                            <?php endforeach;?>

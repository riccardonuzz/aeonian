...
<head>
  ...
  <title>Dashboard installatore | AEONIAN SYSTEM</title>
        ...
        <div class="navbar-fixed">
            <nav class="space-cadet">
                <div class="nav-wrapper">
                    <h1 class="logo-wrapper"><a href="<?php echo ROOT_URL,TEMPLATE_PATH;?>installer-contents/installerhome.php" class="brand-logo darken-1"><img src="<?php echo ROOT_URL,IMAGES_PATH; ?>aeonian-title.png" alt="aeonian logo"></a> <span class="logo-text">Aeonian</span></h1>

                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="thirdparty-details.php?id=<?php echo $terzaparte['IDTerzaParte']; ?>"><?php echo $terzaparte['Nome'] ?></a>
                              <i onclick="elimina('<?php echo ROOT_URL.TEMPLATE_PATH.'user-contents/thirdparties-management.php';?>', '<?php echo $terzaparte['IDTerzaParte'];?>','<?php echo ROOT_URL.TEMPLATE_PATH.'user-contents/thirdparties-management.php';?>')" class="custom-icon mdi-action-delete right"></i>
                            </td>

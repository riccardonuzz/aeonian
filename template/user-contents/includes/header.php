        ...
        <div class="navbar-fixed">
            <nav class="space-cadet">
                <div class="nav-wrapper">
                    <h1 class="logo-wrapper"><a href="<?php echo ROOT_URL.TEMPLATE_PATH?>user-contents/userhome.php" class="brand-logo darken-1"><img src="<?php echo ROOT_URL.IMAGES_PATH; ?>aeonian-title.png" alt="materialize logo"></a> <span class="logo-text">Materialize</span></h1>
                    <ul class="right hide-on-med-and-down">
                        <li><a href="javascript:void(0);" class="waves-effect waves-block waves-light notification-button" data-activates="notifications-dropdown"><i class="mdi-social-notifications"><small class="notification-badge orange-style"><?php echo htmlspecialchars($numeroNotifiche['Totale'], ENT_QUOTES); ?></small></i>
                        </a>
                        </li> 

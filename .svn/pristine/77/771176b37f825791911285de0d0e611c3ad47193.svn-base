...
$impianto = $systemsManager->trovaImpianto($get['id']);
...
if(isset($_POST['submit'])){
  ...
  if($checkValue['error']==2){
    ...
    header('Location: system-details.php?id='.$idimpianto;
  }
}
                              ...
                              <div class="col s12 m8 l12">
                                <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                                  ...
                                  <?php foreach ($clients as $client) :?>
									  ...
									  $str = <<<HTML
<input type='checkbox' id='check_btn$index' value='$client[CodiceFiscale]' name = 'responsabile[]' checked='checked'><label style='color:black' for='check_btn$index'>$client[CodiceFiscale]</label>
HTML;
									echo $str;

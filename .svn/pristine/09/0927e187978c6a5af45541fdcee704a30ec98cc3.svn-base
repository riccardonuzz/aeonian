                          ...
                          <div class="row">
                              ...
                              <div class="input-field col s6">
                                  <select id="ruolo" disabled>
                                        <option value="<?php echo $role['Ruolo']; ?>" disabled selected><?php echo htmlspecialchars($userDetails['Ruolo'], ENT_QUOTES); ?></option>
                                  </select>
                              </div>
                          ...
                          <div class="row">
                            <div class="input-field col s4">
                              <?php
                                ...
                                {
                                    $escaped = htmlspecialchars_decode(
    htmlentities($_SESSION['message'], ENT_NOQUOTES, 'UTF-8', false)
  , ENT_NOQUOTES
);
									  $str = <<<HTML

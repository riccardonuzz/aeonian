    ...
    <section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <a onclick="elimina('<?php echo ROOT_URL.TEMPLATE_PATH.'installer-contents/environments-management.php';?>', '<?php echo $ambiente['IDAmbiente'];?>','<?php echo ROOT_URL.TEMPLATE_PATH?>installer-contents/system-details.php?id=<?php echo $ambiente['Impianto']?>')" class="btn waves-effect card4-color white-text right"><i class="mdi-action-delete right"></i>Elimina</a>

    ...
    <section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <a onclick="elimina('<?php echo ROOT_URL.TEMPLATE_PATH.'installer-contents/sensors-management.php';?>', '<?php echo $sensore['IDSensore'];?>','<?php echo ROOT_URL.TEMPLATE_PATH?>installer-contents/environment-details.php?id=<?php echo $sensore['Ambiente']?>')" style='margin-left: 0.5em;' class="btn waves-effect card4-color white-text right"><i class="mdi-action-delete right"></i>Elimina</a>
                        ...
                        <?php foreach ($regoleSensore as $rule) :?>
                          <tr>
                            ...
                            <td class="custom-cell">
                              ...
                              <i onclick="elimina('<?php echo ROOT_URL.TEMPLATE_PATH.'installer-contents/notify-management.php';?>', '<?php echo $rule['IDRegola']; ?>','<?php echo ROOT_URL.TEMPLATE_PATH.'installer-contents/sensor-details.php?id='.$sensore['IDSensore'];?>')"  class="custom-icon btn-warning-confirm mdi-action-delete"></i>
                            </td>                            
                          </tr>                                
                        <?php endforeach;?>
